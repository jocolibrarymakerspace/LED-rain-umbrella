...
#define LED_COUNT 17      // how many LEDs in the strip/ring
#define DRIVER WS2812B   // which FastLED driver to use

// Configure behavior
#define DECAY_DELAY 20    // delay between each tick
#define BRIGHT_BASE 50   // minimum brightness for a fresh drop
#define BRIGHT_ADD 105    // add this to above for maximum brightness of a fresh drop
 ...
 */
CHSV seed_drop() {
    CHSV drop = CHSV(HUE_GREEN, 255, random8(BRIGHT_BASE)+BRIGHT_ADD);
    return(drop);
}
